...
class inputs(object):
    ...
    def getNPArray(self, d):
        ...
        if not self.testingData:
            ...
            if os.path.isfile("train_inputs2.npy") and os.path.isfile("train_outputs2.npy") : 
                print ("Data picked from memory.")
                train_inputs_np = np.load("train_inputs2.npy")
                train_outputs_np = np.load("train_outputs2.npy")
                ...
                while (self.counter < c):
                    ...
                    np.save('train_inputs2', train_inputs_np)
                    np.save('train_outputs2', train_outputs_np)
            ...
            if os.path.isfile("test_inputs2.npy") : 
                print ("Data picked from memory.")
                test_inputs_np = np.load("test_inputs2.npy")
                ...
                while (self.counter <= c):
                    ...
                    # Save as numpy array files
                    np.save('test_inputs2', test_inputs_np)
                    os.chdir('..')
